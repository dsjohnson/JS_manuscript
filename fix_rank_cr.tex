...
\subsection{Additional computation benefits}
...
\begin{aligned}
[\bz, \bz_u, n_u, \bt,\lambda,|\bx] &\propto [n_u|\bt,\lambda,\bx][\bz_u|n_u,\bt,\bx][\bz|\bt,\bx] \\
&\qquad  \times [\bx|\bt,n][n|\bt,\lambda][\bt][\lambda] \\
&= [n_u,\bz_u, \bz|\bt,\lambda,\bx] \times [n|\bt,\lambda][\bx|\bt][\bt][\lambda]
\end{aligned}
\end{equation} 
...
\begin{equation}
[\bx|\bt] = \prod_{i=1}^n [\bx_i|\bt] = \prod_{j=1}^m w_j[\bu_i|\bt]
\end{equation}
